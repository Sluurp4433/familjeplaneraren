...
type AuthContextValue = {
  ...
  loading: boolean
  /** Godkänd av superadmin (eller själv superadmin) – har åtkomst till appen alls. */
  isApproved: boolean
  isSuperAdmin: boolean
  refreshProfile: () => Promise<void>
  signIn: (email: string, password: string) => Promise<void>
  /** Returnerar true om en bekräftelse-mejl skickats (ingen session ännu). */
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const value: AuthContextValue = {
    ...
    profile,
    loading,
    isApproved: profile?.approved === true || profile?.is_super_admin === true,
